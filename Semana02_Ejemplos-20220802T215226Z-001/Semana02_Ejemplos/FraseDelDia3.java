...
public class FraseDelDia3 {
    ...
    static int obtenerNumeroAleatorio(){
        int numero;
        numero = (int)Math.round(Math.random()*4)+1;
        return numero;
    }

    static String obtenerFrase(int nro_frase){
        String frase = "";
    ...
    static void mostrarFrase(String frase){
        JOptionPane.showMessageDialog(null,
                "La Frase del Día es:.\n" +
                frase);
    }
